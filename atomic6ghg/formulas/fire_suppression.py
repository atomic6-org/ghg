...
from atomic6ghg.factors import refrigerants_gwp_factors, fire_suppression_leak_rates_factors, \
...
class FireSuppression(Formula):
    ...
    def make_material_balance(self):
        ...
        for row in self.wks_data.get('materialBalance', []):
            ...
            co2_equivalent_emissions = FireSuppression.calculate_co2_emissions_material_balance(gwp,
    ...
    def make_simplified_material_balance(self):
        ...
        for row in self.wks_data.get('simplifiedMaterialBalance', []):
            ...
            co2_equivalent_emissions = \
                FireSuppression.calculate_co2_emissions_simplified_material_balance(gwp, new_units_charge,
    ...
    def make_screening_method(self):
        ...
        for row in self.wks_data.get('screeningMethod', []):
            ...
            co2_equivalent_emissions = FireSuppression.calculate_co2_emissions_screening_method(gwp,
                type_of_equipment, unit_capacity)
    ...
    def calculate_co2_emissions_screening_method(gwp, type_of_equipment, unit_capacity):
        """Calculate CO2 emissions for a gas given simplified material balance inputs"""
        co2_equivalent_emission_factor = \
            fire_suppression_leak_rates_factors[type_of_equipment]
    ...
    def make_co2_equivalent_emissions(self):
        ...
        total = (unit_conversions_factors['pounds']['kilogram'] *
